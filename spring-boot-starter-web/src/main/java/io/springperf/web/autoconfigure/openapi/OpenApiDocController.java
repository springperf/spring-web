 ...
 * <p>Activated when {@link OpenApiCustomiser} (springdoc-openapi-common) is on the classpath.
...
public class OpenApiDocController {
    ...
    public OpenApiDocController(OpenApiCustomiser openApiCustomiser, OpenApiProperties openApiProperties) {
