 ...
 */
public class PerfMappingDescriptionProvider implements MappingDescriptionProvider {

    private static final String MAPPING_NAME = "perfMappings";
    private final WebContext webContext;

    public PerfMappingDescriptionProvider(WebContext webContext) { this.webContext = webContext; }
