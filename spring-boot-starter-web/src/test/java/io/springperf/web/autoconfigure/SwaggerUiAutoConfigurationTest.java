...
class SwaggerUiAutoConfigurationTest {
    ...
    void openApiDocController_returnsNewInstanceEachCall() {
        assertNotSame(config.openApiDocController(mock(OpenApiCustomizer.class), new OpenApiProperties()),
                config.openApiDocController(mock(OpenApiCustomizer.class), new OpenApiProperties()));
    }
