...
class PerfActuatorPathMappingContextTest {
    ...
    void constructor_linksEndpoint_setsFields() {
        ...
        PerfActuatorPathMappingContext ctx = new PerfActuatorPathMappingContext(
    ...
    private static ApiVersion invokeResolveApiVersion(PerfActuatorPathMappingContext ctx, List<MediaType> accepts) throws Exception {
        Method method = PerfActuatorPathMappingContext.class.getDeclaredMethod("resolveApiVersion", List.class);
        method.setAccessible(true);
        return (ApiVersion) method.invoke(ctx, accepts);
    }

    @SuppressWarnings("unchecked")
    private Map<String, Object> invokeBuildActuatorArguments(PerfActuatorPathMappingContext ctx) throws Exception {
        Method method = PerfActuatorPathMappingContext.class.getDeclaredMethod("buildActuatorArguments", WebServerHttpRequest.class);
        method.setAccessible(true);
