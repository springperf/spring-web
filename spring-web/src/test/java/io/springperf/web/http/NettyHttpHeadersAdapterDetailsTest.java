...
class NettyHttpHeadersAdapterDetailsTest {
    ...
    void readOnly_get_keySet_values_entrySet() {
        ...
        assertEquals(List.of("1"), adapter.get("A"));
    ...
    void readOnly_writeOperations_throwUnsupported() {
        ...
        assertThrows(UnsupportedOperationException.class, () -> adapter.addAll("A", List.of("1")));
        ...
        assertThrows(UnsupportedOperationException.class, () -> adapter.setAll(Map.of()));
        assertThrows(UnsupportedOperationException.class, () -> adapter.put("A", List.of("1")));
        assertThrows(UnsupportedOperationException.class, () -> adapter.remove("A"));
        assertThrows(UnsupportedOperationException.class, () -> adapter.putAll(Map.of()));
    ...
    void writable_add_addAll_set_delegateToNetty() {
        ...
        assertEquals(List.of("1"), netty.getAll("A"));
        assertEquals(List.of("2", "3"), netty.getAll("B"));
        assertEquals(List.of("4"), netty.getAll("C"));
    }
    ...
    void writable_addAllMultiValueMap_setAll() {
        ...
        src.add("X", "b");
        adapter.addAll(src);
        assertEquals(List.of("a", "b"), netty.getAll("X"));

        adapter.setAll(Map.of("Y", "c"));
        assertEquals(List.of("c"), netty.getAll("Y"));
    }
    ...
    void writable_put_returnsPrevious() {
        ...
        List<String> previous = adapter.put("A", List.of("new1", "new2"));
        assertEquals(List.of("old"), previous);
        assertEquals(List.of("new1", "new2"), netty.getAll("A"));

        assertNull(adapter.put("B", List.of("1")));
    }
    ...
    void writable_remove_existingAndMissing() {
        ...
        assertEquals(List.of("1"), adapter.remove("A"));
    ...
    void webHttpHeaders_mapOperations_delegate() {
        ...
        assertEquals(List.of("1", "2"), view.get("A"));
    ...
    void webHttpHeaders_put_putAll_clear_values_entrySet() {
        WebHttpHeaders view = new WebHttpHeaders();
        view.put("A", List.of("1"));
        view.put("B", List.of("2", "3"));
        assertEquals(List.of("1"), view.get("A"));
        assertEquals(List.of("2", "3"), view.get("B"));
        ...
        view.putAll(Map.of("C", List.of("4")));
        assertEquals("4", view.getFirst("C"));
