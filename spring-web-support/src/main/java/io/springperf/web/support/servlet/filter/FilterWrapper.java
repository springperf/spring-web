...
public class FilterWrapper implements WebFilter, LifecycleWebComponent {
    ...
    public void initWithWebContext(WebContext webContext) {
        if (!initialized) {
            ...
            javax.servlet.FilterConfig filterConfig = new PerfFilterConfig(
     ...
     * <ol>
     *   <li>从 {@link javax.servlet.annotation.WebFilter#initParams()} 读取</li>
     *   <li>兜底空 Map</li>
     * </ol>
     */
    protected Map<String, String> resolveInitParams() {
        ...
        javax.servlet.annotation.WebInitParam[] initParams = webFilter.initParams();
        if (initParams == null || initParams.length == 0) {
            return Collections.emptyMap();
        }
        Map<String, String> result = new java.util.HashMap<>(initParams.length);
        for (javax.servlet.annotation.WebInitParam param : initParams) {
    ...
    private static final Map<javax.servlet.Filter, String> COMPONENT_NAMES =
