...
class PerfHttpServletRequestSessionTest {
    ...
    static class DummyUpgradeHandler implements jakarta.servlet.http.HttpUpgradeHandler {
        @Override
    ...
    void upgrade_createsHandler() throws Exception {
        ...
        when(servletResp.getResponse()).thenReturn(webResponse);
        bindResponse(servletResp);
        when(servletResp.getOutputStream()).thenReturn(mock(jakarta.servlet.ServletOutputStream.class));
