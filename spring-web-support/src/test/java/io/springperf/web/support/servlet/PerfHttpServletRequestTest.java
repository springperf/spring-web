...
class PerfHttpServletRequestTest {
    ...
    @Test void login_throwsServletExceptionWithoutManager() {
        assertThrows(javax.servlet.ServletException.class, () -> {
            try { servletRequest.login("u", "p"); } catch (javax.servlet.ServletException e) { throw e; }
        });
    }
    @Test void logout_doesNothing() throws javax.servlet.ServletException { servletRequest.logout(); }
    ...
    void getParts_notMultipart_throws() {
        ...
        assertThrows(javax.servlet.ServletException.class, () -> servletRequest.getParts());
    }
    ...
    void setDispatcherType_updatesGetDispatcherType() {
        servletRequest.setDispatcherType(javax.servlet.DispatcherType.FORWARD);
        assertEquals(javax.servlet.DispatcherType.FORWARD, servletRequest.getDispatcherType());
    }

    static class TestHttpUpgradeHandler implements javax.servlet.http.HttpUpgradeHandler {
        @Override public void init(javax.servlet.http.WebConnection wc) { }
